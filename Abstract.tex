...
Rivals of Aether does not feature a health bar, nor does it count the amount of damage until one's defeat. Instead, similar to any smash bros. game, it counts damage received as a multiplier, taking affect when being launched by an attack. Simply put: attack moves do both damage and also launch their victim. Some moves will be more damaging than launching, some exactly the opposite. Additionally, the amount of players able to play in a match \ %expand on this

Game modes\ %expand. note the online play and the tutorial, also story mode


Characters in the game are:\
Zetterburn, Kragg, Wrastor, Orcane, Forsburn, Etalus,  %set characters, explain moves, hint at balance
