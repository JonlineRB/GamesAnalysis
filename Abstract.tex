...
%header / footer statements
\usepackage{fancyhdr}
\pagestyle{fancy}
\lhead{Game Analysis: Rivals of Aether - Jonathan Borowski}
...
\vspace*{\stretch{1.0}}
   \begin{center}
      ...
      \includegraphics[height=9cm]{Rivals-of-Aether.png}      
   \end{center}
   \vspace*{\stretch{2.0}}
\end{titlepage}
...
\begin{center}
	\includegraphics[height=7cm]{galerie-rivals-aether_3.jpg}\\
	Wrastor and Kragg dueling at Air Armada \cite{img:19}\\
\end{center}
...
\begin{center}
	\includegraphics[height=7cm]{smash.jpg}\\
	Original Super Smash Bros. for the N64 \cite{img:20}\\
\end{center}
...
\begin{center}
\includegraphics[height = 7cm]{CharacterSelect.jpg}\\
Character selection screen \cite{img:21}\\
\end{center}
...
\begin{center}
\includegraphics[height=7cm]{tempest.png}\\
Absa and Wrastor at Tempest Peak\cite{img:22}\\
\end{center}
...
Aether mode: has not been unlocked.%expand
\\
...
\begin{center}
\includegraphics[height=7cm]{custom-colors.png}\\
Custom colors editor \cite{img:23}\\
\end{center}
...
Multiple users noted how delighted they were to play a Smash game on PC. Praised were the graphics, the online modes and the tutorial. Criticized were the small cast and lack of diverse modes in comparison to the smash series. \cite{metacritic:7}\\ %cite
\end{itemize}
...
\begin{center}
\includegraphics[height=7cm]{Rivals-Championship-Series.jpg}\\
Rivals of Aether Championship series\cite{img:24}\\
\end{center}
